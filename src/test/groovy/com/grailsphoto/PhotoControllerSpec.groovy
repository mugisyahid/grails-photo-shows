...
class PhotoControllerSpec extends Specification {
    ...
    void "Test the save action with an invalid instance"() {
        given:
        controller.photoService = Mock(PhotoService) {
            1 * save(_ as Photo) >> { Photo photo ->
                throw new ValidationException("Invalid instance", photo.errors)
            }
        }
